...
namespace ShearCell_Interaction.View
{
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        //public static double CellScale = 20; //25.0; //50;
        //public static int VertexVisualSize = 4;
        ...
        private bool _hideInitialCells;
        public bool HideInitialCells
        {
            get { return _hideInitialCells; }
            set {
                _hideInitialCells = value;
                UpdateVisibilities();
                OnPropertyChanged();
            }
        }
        ...
        public int NumberPathSamples
        {
            get { return _numberPathSamples; }
            set { _numberPathSamples = value; OnPropertyChanged(); }
        }
        public int MaxNumScalesOptimization
        {
            get { return _maxNumScalesOptimization; }
            set { _maxNumScalesOptimization = value; OnPropertyChanged(); }
        }
        ...
        public bool BruteForceAnchors { get; set; }
        ...
        private int _maxNumScalesOptimization;
        private int _numberPathSamples;
        ...
        public ViewModel(MetamaterialModel model)
        {
            ...
            MaxNumScalesOptimization = 5;
            NumberPathSamples = 30;
            NumberIterationsGeneration = 200;

            BruteForceAnchors = false;
        }
        ...
        public void MarkNonShearingCells()
        {
            ...
            for (var i = 0; i < Model.Cells.Count; i++)
            {
                ...
                foreach (var component in Model.ConstraintGraph)
                {
                    ...
                    {
                        var cellPosition = cell.IndexVertex.ToVector();
                        ...
                        //else
                        //DeformedShapeItems.Add(polygon);
                    }
                }
            }
        }
