...
namespace ShearCell_Interaction.Helper
{
    public static class PolylineHelper
    {
        ...
        public static List<Vector> Rotate(List<Vector> target, double angle, double centerX, double centerY)
        {
            var transform = new RotateTransform(angle, centerX, centerY);
            var transformedPoints = new List<Vector>();

            foreach (var vector in target)
            {
                var transformedPoint = transform.Transform(new Point(vector.X, vector.Y));
                transformedPoints.Add(new Vector(transformedPoint.X, transformedPoint.Y));
            }

            return transformedPoints;
        }
        public static List<Vector> Scale(List<Vector> target, double scaleX, double scaleY)
        {
        ...
        public static List<Vector> Translate(List<Vector> target, double scaleX, double scaleY)
        {
            var transform = new TranslateTransform(scaleX, scaleY);
            var transformedPoints = new List<Vector>();
