...
namespace ShearCell_Interaction.Helper
{
    public class CoordinateConverter
    {
        ...
        public static PointCollection ConvertGlobalToScreenCoordinates(List<Vector> globalGridPosition)
        {
            var pointCollection = new PointCollection();

            foreach (var globalPoint in globalGridPosition)
            {
                var localPoint = ConvertScreenToGlobalCellCoordinates(globalPoint);
